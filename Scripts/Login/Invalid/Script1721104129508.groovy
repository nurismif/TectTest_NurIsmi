...
WebUI.setText(findTestObject('Login/Page_CURA Healthcare Service/Input_Username'), 'John Doa')

WebUI.setEncryptedText(findTestObject('Login/Page_CURA Healthcare Service/Input_Password'), 'g3/DOGG74jC3Flrr3yH+3NP2UI0sD1V1')

WebUI.click(findTestObject('Object Repository/Login/Page_CURA Healthcare Service/button_Login'))

WebUI.verifyElementPresent(findTestObject('Login/Page_CURA Healthcare Service/p_Login failed Please ensure the username a_eb55b5'), 
    0)
